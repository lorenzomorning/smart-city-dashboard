...
const BicycleInfrastructureComponent = () => {
  return (
    <BaseWidgetComponent
      ...
      dataSource={`
Hier öknnen Sie die Rad-Infrastruktur der Stadt Münster entdecken. Die Daten stammen von der OpenData Plattform OpenStreetMap und werden durch das Smart-City Dashboard so aufbereitet, dass sie in ihren Einzelheiten (z.B. Separarierte Radwege, Radwege-Netz, Fahrradstraßen 2.0, Parkeinheiten, Fahrradläden, Reparaturstationen, Wegweiser, Rad-Ampeln), sowie auch auf Stadtteil-Ebene erkundet werden können. Auf dieser einheitlichen Daten-Grundlage kann ein ergebnisorientierter Dialog zwischen der Stadt Münster und ihren Bürger*innen gefördert werden und gemeinsame Entscheidungen getroffen werden.

OpenStreetMap ist eine in eine OpenData-Initiative, welche 2004 gegründet worden ist und heute das größte öffentliche Geoportal für allgemeine Infrastrukturen oder Landnutzungen darstellt. Alle Daten werden von Nutzer*innen und somit normalen Bürger*innen gemappt und geordnet. Daher kann der Datensatz für Münsters Rad-Infrastruktur keine Vollständigkeit garantieren, kann aber durch Sie selber um neue Objekte erweitert werden ([Einführung in OSM](https://wiki.openstreetmap.org/wiki/Main_Page)). Durch seine OpenData-Orientierung gibt es zahlreiche App-Anwendungen auch im Radverkehr, und -sport (komoot oder strava). 
